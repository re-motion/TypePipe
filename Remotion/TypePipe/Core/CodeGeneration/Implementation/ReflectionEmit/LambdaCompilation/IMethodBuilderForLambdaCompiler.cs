...
namespace Remotion.TypePipe.CodeGeneration.Implementation.ReflectionEmit.LambdaCompilation
{
  /// <summary>
  ...
  /// </summary>
  /// <remarks>
  /// This interface is internal because it is only used to hack up the <see cref="LambdaCompiler"/>.
  /// </remarks>
