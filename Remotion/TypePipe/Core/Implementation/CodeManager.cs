...
namespace Remotion.TypePipe.Implementation
{
  ...
  /// Note that the <see cref="ICodeGenerator"/> instance is guarded by the specified lock.
  /// </summary>
  public class CodeManager : ICodeManager
  {
    ...
    public CodeManager (ICodeGenerator codeGenerator, object codeGeneratorLock, ITypeCache typeCache)
    {
    ...
    {
      get { lock (_codeGeneratorLock) return _codeGenerator.AssemblyDirectory; }
    }

    public string AssemblyName
    {
      get { lock (_codeGeneratorLock) return _codeGenerator.AssemblyName; }
    }
