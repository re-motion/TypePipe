...
namespace Remotion.TypePipe.IntegrationTests.ObjectFactory
{
  ...
  public class LoadFlushedCodeTest : IntegrationTestBase
  {
    ...
    {
      _typeCache.LoadFlushedCode (_assembly1);
      _typeCache.LoadFlushedCode (_assembly2);
    ...
    public void LoadAssemblyGeneratedByDifferentParticipantConfiguration ()
    {
      ...
      objectFactory.TypeCache.LoadFlushedCode (_assembly1);
    }
    ...
    {
      _typeCache.LoadFlushedCode (GetType ().Assembly);
    }
