...
namespace Remotion.TypePipe.IntegrationTests.Pipeline
{
  ...
  public class ReflectionServiceTest : IntegrationTestBase
  {
    ...
    {
      var equivalentReflectionService = PipelineFactory.Create (_pipeline.ParticipantConfigurationID).ReflectionService;
      var otherReflectionService = PipelineFactory.Create ("other id").ReflectionService;
      ...
      Assert.That (instance2.GetType(), Is.SameAs (assembledType1));
