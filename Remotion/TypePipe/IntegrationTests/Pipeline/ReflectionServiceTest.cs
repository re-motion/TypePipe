...
namespace Remotion.TypePipe.IntegrationTests.Pipeline
{
  ...
  public class ReflectionServiceTest : IntegrationTestBase
  {
    ...
    public void InstantiateAssembledType ()
    {
      ...
      // TODO 5370: AssembledType does not contain the participant configuration ID.
      // Type.Assembly does not return the attribute because we add it just before flushing!
      // What to do?
