...
namespace Remotion.TypePipe.UnitTests.MutableReflection.Implementation
{
  public static class CustomMethodInfoObjectMother
  {
        ...
        IEnumerable<ICustomAttributeData> customAttributes = null)
    {
      ...
      var customMethod = new TestableCustomMethodInfo (declaringType, name, attributes);
      customMethod.ReturnParameter_ = returnParameter;
      customMethod.Parameters = parameters.ToArray();
      customMethod.BaseDefinition = baseDefinition;
      customMethod.CustomAttributeDatas = customAttributes.ToArray();
