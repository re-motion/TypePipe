...
namespace Remotion.TypePipe.IntegrationTests.TypeAssembly
{
  ...
  public class GetOrAddOverrideBaseMethodTest : TypeAssemblerIntegrationTestBase
  {
    ...
    public void BaseMethod_GenericMethodWithConstraints ()
    {
      ...
      var instance = (DomainType) Activator.CreateInstance (type);
      Assert.That (instance.GenericMethodWithConstraints<TypeImplementingConstrainingInterface>(), Is.EqualTo ("value"));
    }
      ...
      AssembleType<DomainType> (
          proxyType =>
          {
            ...
            Assert.That (
                ...
                Throws.TypeOf<ArgumentException>().With.Message.StartsWith ("Only virtual methods can be overridden."));
          });
    }
