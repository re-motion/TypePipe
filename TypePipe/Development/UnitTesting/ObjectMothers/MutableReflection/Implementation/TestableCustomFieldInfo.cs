...
{
  public class TestableCustomFieldInfo : CustomFieldInfo
  {
    public TestableCustomFieldInfo (CustomType declaringType, string name, Type type, FieldAttributes attributes)
